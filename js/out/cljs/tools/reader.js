...
var G__25479 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__25479;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__25480 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25480,ch);
...
if(("\\" === ch__$1)){
var ch_25481__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_25481__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_25481__$2);
} else {
}

var G__25482 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__25482;
continue;
}
}
...
var vec__25490 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25490,(0),null);
var start_column = cljs.core.nth.call(null,vec__25490,(1),null);
...
var G__25493 = cljs.core.conj_BANG_.call(null,a,form);
a = G__25493;
continue;
}
}
...
var _STAR_read_delim_STAR_25494 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_25494;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__25495 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25495,(0),null);
var start_column = cljs.core.nth.call(null,vec__25495,(1),null);
...
var vec__25498 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25498,(0),null);
var end_column = cljs.core.nth.call(null,vec__25498,(1),null);
...
var vec__25501 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25501,(0),null);
var start_column = cljs.core.nth.call(null,vec__25501,(1),null);
...
var vec__25504 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25504,(0),null);
var end_column = cljs.core.nth.call(null,vec__25504,(1),null);
...
var vec__25507 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25507,(0),null);
var start_column = cljs.core.nth.call(null,vec__25507,(1),null);
...
var vec__25510 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25510,(0),null);
var end_column = cljs.core.nth.call(null,vec__25510,(1),null);
...
var sb = (function (){var G__25513 = (new goog.string.StringBuffer());
G__25513.append(initch);
...
var G__25515 = (function (){var G__25514 = sb;
G__25514.append(ch);

return G__25514;
})();
var G__25516 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__25515;
ch = G__25516;
continue;
}
...
switch (G__25519) {
case "\\":
var G__25523 = (function (){var G__25520 = sb;
G__25520.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__25520;
})();
var G__25524 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25523;
ch = G__25524;
continue;
...
break;
default:
var G__25525 = (function (){var G__25521 = sb;
G__25521.append(ch);

return G__25521;
})();
var G__25526 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25525;
ch = G__25526;
continue;
...
var vec__25527 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25527,(0),null);
var end_column = cljs.core.nth.call(null,vec__25527,(1),null);
...
var vec__25530 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25530,(0),null);
var column = cljs.core.nth.call(null,vec__25530,(1),null);
...
var vec__25535 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25535,(0),null);
var column = cljs.core.nth.call(null,vec__25535,(1),null);
...
var vec__25540 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25540,(0),null);
var column = cljs.core.nth.call(null,vec__25540,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__25545 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25545,(0),null);
var start_column = cljs.core.nth.call(null,vec__25545,(1),null);
...
var vec__25548 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25548,(0),null);
var end_column = cljs.core.nth.call(null,vec__25548,(1),null);
...
var G__25551 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__25551,true,null,opts,pending_forms);
...
var G__25552 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__25552)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__25552)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__25552)){
...
var _STAR_suppress_read_STAR_25553 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25553;
}});
...
var G__25554 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__25554,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__25554,rdr,first_line);
...
var G__25558 = matched;
var G__25559 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__25558;
finished = G__25559;
continue;
} else {
...
var _STAR_suppress_read_STAR_25560 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25560;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env25561 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__25562 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25562,"(");
...
var G__25563 = (i + (1));
var G__25564 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env25561;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__25565 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__25565);
...
var G__25566 = cljs.core.next.call(null,s__$1);
var G__25567 = ret;
s__$1 = G__25566;
r = G__25567;
continue;
...
var G__25568 = cljs.core.next.call(null,s);
var G__25569 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__25568;
key_vals = G__25569;
continue;
} else {
...
var gensym_env25573 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env25573;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__25574 = token;
var G__25574__$1 = (((G__25574 == null))?null:cljs.core.subs.call(null,G__25574,(1)));
var G__25574__$2 = (((G__25574__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25574__$1));
var G__25574__$3 = (((G__25574__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25574__$2));
var G__25574__$4 = (((G__25574__$3 == null))?null:cljs.core.symbol.call(null,G__25574__$3));
if((G__25574__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__25574__$4);
}
})():(function (){var G__25575 = token;
var G__25575__$1 = (((G__25575 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25575));
if((G__25575__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25575__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__25586,reader){
var map__25587 = p__25586;
var map__25587__$1 = ((((!((map__25587 == null)))?(((((map__25587.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25587.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25587):map__25587);
var opts = map__25587__$1;
var eof = cljs.core.get.call(null,map__25587__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___25595 = arguments.length;
var i__4500__auto___25596 = (0);
while(true){
if((i__4500__auto___25596 < len__4499__auto___25595)){
args__4502__auto__.push((arguments[i__4500__auto___25596]));

var G__25597 = (i__4500__auto___25596 + (1));
i__4500__auto___25596 = G__25597;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq25593){
var G__25594 = cljs.core.first.call(null,seq25593);
var seq25593__$1 = cljs.core.next.call(null,seq25593);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25594,seq25593__$1);
});


//# sourceMappingURL=reader.js.map?rel=1528903107141
