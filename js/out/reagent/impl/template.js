...
var G__24878 = o;
(G__24878[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__24880__i < G__24880__a.length) {G__24880__a[G__24880__i] = arguments[G__24880__i + 0]; ++G__24880__i;}
  args = new cljs.core.IndexedSeq(G__24880__a,0,null);
} 
...
var G__24882 = o;
(G__24882[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__24887 = props;
var G__24887__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__24887,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24887);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__24887__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__24888){
...
var props = map__24889__$1;
var class$ = cljs.core.get.call(null,map__24889__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__24889,map__24889__$1,props,class$){
return (function (c){
...
});})(map__24889,map__24889__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__24891){
var map__24892 = p__24891;
var map__24892__$1 = ((((!((map__24892 == null)))?(((((map__24892.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24892.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24892):map__24892);
var on_write = cljs.core.get.call(null,map__24892__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__24892,map__24892__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__24892,map__24892__$1,on_write))
);
} else {
...
var G__24895 = jsprops;
(G__24895["defaultValue"] = value);

(G__24895["onChange"] = ((function (G__24895,v,value,on_change){
return (function (p1__24894_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24894_SHARP_);
});})(G__24895,v,value,on_change))
);
...
var vec__24898 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24898,(0),null);
var id = cljs.core.nth.call(null,vec__24898,(1),null);
var class$ = cljs.core.nth.call(null,vec__24898,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___24902 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___24902 == null)){
} else {
var key_24903 = temp__5461__auto___24902;
...
var temp__5461__auto___24904 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___24904 == null)){
} else {
var key_24905 = temp__5461__auto___24904;
reagent.impl.template.oset.call(null,jsprops,"key",key_24905);
}
...
var G__24906 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__24906["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24909){
var G__24910 = cljs.core.first.call(null,seq24909);
var seq24909__$1 = cljs.core.next.call(null,seq24909);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24910,seq24909__$1);
});
...
break;
default:
var G__24916 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__24916;
continue;
...
var n__4376__auto___24918 = a.length;
var i_24919 = (0);
while(true){
if((i_24919 < n__4376__auto___24918)){
(a[i_24919] = reagent.impl.template.as_element.call(null,(a[i_24919])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___24921 = a.length;
var i_24922 = (0);
while(true){
if((i_24922 < n__4376__auto___24921)){
var val_24923 = (a[i_24922]);
if(((cljs.core.vector_QMARK_.call(null,val_24923)) && ((reagent.impl.template.key_from_vec.call(null,val_24923) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_24922] = reagent.impl.template.as_element.call(null,val_24923));
...
var ctx = ({});
var vec__24925 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__24925,(0),null);
var derefed = cljs.core.nth.call(null,vec__24925,(1),null);
...
var G__24928 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24928) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__24928){
...
//# sourceMappingURL=template.js.map?rel=1528903101387
