...
if((i < len)){
var k = (ks[i]);
var G__24831 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__24832 = (i + (1));
m = G__24831;
i = G__24832;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__24834 = c;
var G__24834__$1 = (((G__24834 == null))?null:G__24834.prototype);
if((G__24834__$1 == null)){
return null;
} else {
return (G__24834__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__24836 = c;
var G__24836__$1 = (((G__24836 == null))?null:G__24836.prototype);
if((G__24836__$1 == null)){
return null;
} else {
return (G__24836__$1["render"]);
}
})() == null))));
});
...
while (G__24840__i < G__24840__a.length) {G__24840__a[G__24840__i] = arguments[G__24840__i + 0]; ++G__24840__i;}
  args = new cljs.core.IndexedSeq(G__24840__a,0,null);
} 
...
var _STAR_current_component_STAR_24843 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_24843;
}});
...
return ((function (G__24844,G__24844__$1){
...
var c = this;
var G__24849_24851 = (c["cljsRatom"]);
if((G__24849_24851 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24849_24851);
}
...
var renders_24853 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_24854 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_24853));
if((cljs.core.count.call(null,renders_24853) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_24853))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_24854)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_24854))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__24852 = name;
switch (G__24852) {
case "":
...
var G__24856 = o;
(G__24856[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__24857 = fiber;
var G__24857__$1 = (((G__24857 == null))?null:(G__24857["type"]));
if((G__24857__$1 == null)){
return null;
} else {
return (G__24857__$1["displayName"]);
}
})();
var parent = (function (){var G__24858 = fiber;
if((G__24858 == null)){
return null;
} else {
return (G__24858["return"]);
}
})();
var path = (function (){var G__24859 = parent;
var G__24859__$1 = (((G__24859 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__24859));
if((G__24859__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24859__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__24861 = c;
if((G__24861 == null)){
return null;
} else {
return (G__24861["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__24862._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__24864 = c;
if((G__24864 == null)){
return null;
} else {
return (G__24864["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__24866 = c;
if((G__24866 == null)){
return null;
} else {
return G__24866._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__24868 = instance;
if((G__24868 == null)){
return null;
} else {
return (G__24868["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__24869 = instance;
if((G__24869 == null)){
return null;
} else {
return G__24869._currentElement;
}
}
})();
var name = (function (){var G__24870 = elem;
var G__24870__$1 = (((G__24870 == null))?null:(G__24870["type"]));
if((G__24870__$1 == null)){
return null;
} else {
return (G__24870__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__24872 = elem;
if((G__24872 == null)){
return null;
} else {
return (G__24872["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__24873._owner;
}
}
})();
var path = (function (){var G__24874 = owner;
var G__24874__$1 = (((G__24874 == null))?null:reagent.impl.component.component_path.call(null,G__24874));
if((G__24874__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24874__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__24875 = c;
var G__24875__$1 = (((G__24875 == null))?null:G__24875.constructor);
if((G__24875__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__24875__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1528903100819
