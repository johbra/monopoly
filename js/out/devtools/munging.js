...
var o22680 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22680["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22681 = temp__5455__auto____$1;
return (o22681["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22215__auto__ = f;
return (o__22215__auto__["toString"]).call(o__22215__auto__);
} else {
return "";
}
...
try{var o__22215__auto___22684 = t;
(o__22215__auto___22684["cljs$lang$ctorPrWriter"]).call(o__22215__auto___22684,t,writer);
}catch (e22683){var __22685 = e22683;
}
...
var char_code = (function (){var o__22215__auto__ = (new String(char$));
return (o__22215__auto__["charCodeAt"]).call(o__22215__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22215__auto__ = String;
return (o__22215__auto__["fromCharCode"]).call(o__22215__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22686 = num_code;
switch (G__22686) {
case (1):
return (185);
...
var o__22215__auto__ = String;
return (o__22215__auto__["fromCharCode"]).call(o__22215__auto__,superscript_code);
});
/**
...
}catch (e22688){var _e__22222__auto__ = e22688;
return false;
}})())){
...
var vec__22689 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22689,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22692 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22692["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22693 = temp__5455__auto____$1;
return (o22693["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22696){
var vec__22697 = p__22696;
var ns_detector = cljs.core.nth.call(null,vec__22697,(0),null);
...
var G__22703 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22704 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22703;
remaining_tokens = G__22704;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22694){
...
var vec__22708 = cljs.core.split_with.call(null,(function (p1__22707_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22707_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22708,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22708,(1),null);
...
var vec__22711 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22711,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22711,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22714 = cljs.core.rest.call(null,remaining_tokens);
var G__22715 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22714;
name_tokens = G__22715;
continue;
} else {
...
var vec__22718 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22718,(0),null);
var arity = cljs.core.nth.call(null,vec__22718,(1),null);
var vec__22721 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22721,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22721,(1),null);
var vec__22724 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22724,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22724,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22724,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22724,(3),null);
...
var vec__22730 = result;
var munged_ns = cljs.core.nth.call(null,vec__22730,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22730,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22730,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22730,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22730,(4),null);
var arity = cljs.core.nth.call(null,vec__22730,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22734 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22734,(0),null);
var args = cljs.core.nth.call(null,vec__22734,(1),null);
var vec__22737 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22737,(0),null);
var name = cljs.core.nth.call(null,vec__22737,(1),null);
...
var G__22740 = (arity + (1));
var G__22741 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22742){
var vec__22743 = p__22742;
var arity = cljs.core.nth.call(null,vec__22743,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22743,(1),null);
...
return cljs.core.get.call(null,arities,p1__22746_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22747_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22750){
var vec__22751 = p__22750;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22751,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22748){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22759__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22759__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22759__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22759__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22760 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22760,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22760,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22760,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22760,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22760,(4),null);
var arity = cljs.core.nth.call(null,vec__22760,(5),null);
...
var o__22215__auto__ = f;
return (o__22215__auto__["getBasis"]).call(o__22215__auto__);
});
/**
...
}catch (e22764){var _e__22222__auto__ = e22764;
...
var G__22765 = (obj[cljs.core.first.call(null,path)]);
var G__22766 = cljs.core.rest.call(null,path);
obj = G__22765;
path = G__22766;
continue;
} else {
...
return (function (accum,p__22767){
var vec__22768 = p__22767;
var bit = cljs.core.nth.call(null,vec__22768,(0),null);
var protocol = cljs.core.nth.call(null,vec__22768,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22771){
var vec__22772 = p__22771;
var ns = cljs.core.nth.call(null,vec__22772,(0),null);
var name = cljs.core.nth.call(null,vec__22772,(1),null);
var selector = cljs.core.nth.call(null,vec__22772,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22777,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22777,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22777,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22775_SHARP_){
return (obj[cljs.core.first.call(null,p1__22775_SHARP_)]);
});})(name,sorted_matches,vec__22777,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1528903083960
