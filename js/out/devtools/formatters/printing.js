...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22808){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22809,G__22810,seq22808__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22814_SHARP_){
return !((cljs.core.meta.call(null,p1__22814_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__22815__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22819){var _e__22222__auto__ = e22819;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e22821){var _e__22222__auto__ = e22821;
return false;
}}
})())){
...
var _STAR_current_state_STAR_22823 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__22824 = opts;
...
var markup_db = cljs.core.get.call(null,map__22824__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_22823;
}});
...
;
var temp__5455__auto___22828 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___22828)){
var managed_print_level_22829 = temp__5455__auto___22828;
var _STAR_print_level_STAR_22827_22830 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_22829;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_22827_22830,managed_print_level_22829,temp__5455__auto___22828,writer,opts,job_fn){
return (function (p1__22826_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22826_SHARP_,null);
});})(_STAR_print_level_STAR_22827_22830,managed_print_level_22829,temp__5455__auto___22828,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_22827_22830;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1528903085544
