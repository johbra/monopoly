...
return (new CustomEvent(event_name,(function (){var obj29051 = {"detail":data};
return obj29051;
})()));
} else {
...
var expr__29059 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
...
return console.warn(p1__29052_SHARP_);
});
...
return console.debug(p1__29053_SHARP_);
});
;})(pred__29058,expr__29059))
} else {
...
return console.error(p1__29054_SHARP_);
});
;})(pred__29058,expr__29059))
} else {
return ((function (pred__29058,expr__29059){
return (function (p1__29055_SHARP_){
return console.log(p1__29055_SHARP_);
});
;})(pred__29058,expr__29059))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29062){
...
var eval_fn = cljs.core.get.call(null,map__29063__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29065_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29067,(0),null);
var v = cljs.core.nth.call(null,vec__29067,(1),null);
...
}catch (e29072){if((e29072 instanceof Error)){
var e = e29072;
return not_found;
} else {
throw e29072;
...
//# sourceMappingURL=utils.js.map?rel=1528903114002
